...
const employeesForgotPassword = async (req, res) => {
    ...
    <div style="margin-top: 30px; font-size: 12px; color: #555; border-top: 1px solid #ddd; padding-top: 10px; text-align: center;">
        <p>This email was sent to you by <strong>logicQr Team</strong>. Please do not reply directly to this email. For assistance, contact us at <a href="thelogicqr@gmail.com" style="color: #007BFF;">thelogicqr@gmail.com</a>.</p>
